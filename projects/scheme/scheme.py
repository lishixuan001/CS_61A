...
##############
'''
scheme_apply call scheme_eval for a user-defined procedure only
scheme_eval computes the value of a symbol through env.lookup(expr)
Error(1) : SchemeError("cannot call: 1")
'''
...
class Frame:
    ...
    def define(self, symbol, value):
        ...
        # BEGIN PROBLEM 3
        '''Define values for symbols in bindings'''
    ...
    def lookup(self, symbol):
        ...
        # Thus we can know that parent should be dictionary
        elif self.parent:
...
def do_and_form(expressions, env):
    ...
    potential error: the returned value should be the last
    """
    # BEGIN PROBLEM 13
    return_value = True
    if not expressions:
...
def do_or_form(expressions, env):
    ...
    potential error: the returned value should be the first True
    """
    # BEGIN PROBLEM 13
    return_value = False
    if not expressions:
